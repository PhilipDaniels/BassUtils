...
namespace ClassLibrary1.MsSql
{
    ...
    public class SqlBulkCopyDataReader : IDataReader
    {
            ...
            )
        {
            ...
            Guard.Argument(bulkCopy.DestinationTableName, nameof(bulkCopy.DestinationTableName)).NotNull().NotEmpty();

            TrimLongStringsInsteadOfThrowing = trimLongStringsInsteadOfThrowing;
            wrappedReader = Guard.Argument(readerToWrap, nameof(readerToWrap)).NotNull().Value;
